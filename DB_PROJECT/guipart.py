...
mcanvas.pack()
mimg = ImageTk.PhotoImage(Image.open("crime5.jpeg"))
...
def CriminalSection():
    ...
    canvas.pack()
    crimg = ImageTk.PhotoImage(Image.open("crime.jpeg"))
    ...
    def AddCrRecord():
        ...
        crimg1 = ImageTk.PhotoImage(Image.open("crime2.jpeg"))
    ...
    def UpdCrRecord():
        ...
        crimg2 = ImageTk.PhotoImage(Image.open("crime3.jpeg"))
    ...
    def ViewCrRecord():
        ...
        crimg3 = ImageTk.PhotoImage(Image.open("crime4.jpeg"))
...
def OfficerSection():
    ...
    canvas = Canvas(root,width=1000,height=1000)
    canvas.pack()
    oimg = ImageTk.PhotoImage(Image.open("officer1.jpeg"))
    ...
    def AddOfRecord():
        ...
        canvas1 = Canvas(w1,width=1000,height=1000)
        canvas1.pack(side=TOP)
        oimg1 = ImageTk.PhotoImage(Image.open("officer2.jpeg"))
    ...
    def UpdOfRecord():
        ...
        canvas2 = Canvas(w2,width=1000,height=1000)
        canvas2.pack(side=TOP)
        oimg2 = ImageTk.PhotoImage(Image.open("officer3.jpeg"))
    ...
    def ViewOfRecord():
        ...
        canvas3 = Canvas(w3,width=1000,height=1000)
        canvas3.pack(side=TOP)
        oimg3 = ImageTk.PhotoImage(Image.open("officer4.jpeg"))
    ...
    def DelOfRecord():
        ...
        canvas2.pack(side=TOP)
        oimg4 = ImageTk.PhotoImage(Image.open("officer3.jpeg"))
...
def CrimeSection():
    ...
    canvas.pack()
    cimg = ImageTk.PhotoImage(Image.open("cr2.jpeg"))
    ...
    def AddCrRecord():
        ...
        canvas1 = Canvas(w1,width=1000,height=1000)
        canvas1.pack(side=TOP)
        cimg1 = ImageTk.PhotoImage(Image.open("cr1.jpeg"))
    ...
    def ViewCRecord():
        ...
        canvas3 = Canvas(w3,width=1000,height=1000)
        canvas3.pack(side=TOP)
        cimg2 = ImageTk.PhotoImage(Image.open("officer4.jpeg"))
...
def charge_sheet():
    ...
    canvas = Canvas(root,width=1000,height=1000)
    canvas.pack()
    csimg = ImageTk.PhotoImage(Image.open("cs1.jpeg"))
    ...
    def AddCsRecord():
        ...
        canvas1 = Canvas(w1,width=1000,height=1000)
        canvas1.pack(side=TOP)
        csimg1 = ImageTk.PhotoImage(Image.open("cs2.jpeg"))
    ...
    def UpdCSRecord():
        ...
        canvas2 = Canvas(w2,width=1000,height=1000)
        canvas2.pack(side=TOP)
        csimg2 = ImageTk.PhotoImage(Image.open("cs3.jpeg"))
    ...
    def ViewCSRecord():
        ...
        canvas3.pack(side=TOP)
        csimg3 = ImageTk.PhotoImage(Image.open("cs4.jpeg"))
...
def firSection():
    ...
    canvas = Canvas(root,width=1000,height=1000)
    canvas.pack()
    fimg = ImageTk.PhotoImage(Image.open("fir1.jpeg"))
    ...
    def AddfiRecord():
        ...
        canvas1 = Canvas(w1,width=1000,height=1000)
        canvas1.pack(side=TOP)
        fimg1 = ImageTk.PhotoImage(Image.open("fir2.jpeg"))
    ...
    def ViewFIRecord():
        ...
        canvas2 = Canvas(w2,width=1000,height=1000)
        canvas2.pack(side=TOP)
        fimg2 = ImageTk.PhotoImage(Image.open("fir3.jpeg"))
